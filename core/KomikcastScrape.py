...
class KomikcastScrape:
    ...
    def scrape(self, url=""):
        url = "https://komikcast.me/{}".format(url)
    ...
    def getIndexManga(self):
        ...
        for i in parse:
            ...
            judul = i.h3.text
            link = i.a["href"].replace('https://komikcast.me/komik','')
            link = "/informasi/"+link+"/"
    ...
    def getMangaContent(self, link):
        link = self.decode(link).replace("https://komikcast.me/chapter/", "")
...
if __name__ == "__main__":
    ...
    print(KS.search("Kanojo"))

    '''
    for i in getIndexManga():
        print(
            'Judul : {}\n'
            'Link  : {}\n'
            'Img   : {}\n'
            'Score : {}\n'
            'Type  : {}\n\n'
            .format(i["judul"], i['link'], i['img'],i['score'],i['type'])
        )
    '''